...
module.exports = function (app) {
  ...
  app.route('/users/:id').get(usersController.getUser).delete(_utilities.adminOnly, usersController.blockUser).put(usersController.updateUser);
  ...
  app.route('/documents').get(documentsController.getDocuments).post(documentsController.createDocument);
