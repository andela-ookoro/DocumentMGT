    ...
    if (document.title && document.body && document.owner === req.user.id) {
      ...
      User.findOne({
        ...
        Document.create(document).then(function (newdocument) {
          return (0, _utilities.sendData)(res, newdocument, 201);
        }).catch(function (err) {
      ...
      return (0, _utilities.sendMessage)(res, 'Document\'s title and body are compulsory.', 500);
    }
  },
  ...
  */
  getDocument: function getDocument(req, res) {
    ...
    Document.findOne({
      ...
      return (0, _utilities.sendData)(res, document, 200);
    }).catch(function (error) {
      return (0, _utilities.sendMessage)(res, error.message, 400);
    });
  },
